...
class PluginAuthentificator extends AbstractGuardAuthenticator
{
    ...
    /**
     * PluginAuthentificator constructor.
     */
    ...
    {
        return $request->headers->has('Autorization');
    }
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        return $this->entityManager->getRepository(Account::class)->findOneBy(['token_plugin' => $apiKey]);
    }
